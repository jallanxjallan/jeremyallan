...
BLOG_TITLE = "Jeremy Allan"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "http://jeremyallan.com/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "http://jeremyallan.com/"
BLOG_EMAIL = "jeremy@jeremyallan.com"
BLOG_DESCRIPTION = "Author Website"  # (translatable)
...
MARKDOWN_EXTENSIONS = ['markdown.extensions.fenced_code', 'markdown.extensions.meta', 'markdown.extensions.extra']
